...
```text
1. User เปิดหน้าแจ้งปัญหา
2. Browser ขอหน้า form จาก server
3. User กรอกข้อมูล
4. User กด submit
5. Browser ส่งข้อมูลไป server
6. Server validate ข้อมูล
7. Server บันทึกข้อมูลลง database
8. Server ส่งผลลัพธ์กลับมา
9. Browser แสดงข้อความว่าส่งสำเร็จ
```
...
TypeScript -> logic และ type safety
Next.js    -> framework สำหรับ web application
Database   -> เก็บข้อมูล
Auth       -> ตรวจสอบตัวตนและสิทธิ์
GitHub     -> เก็บและทำงานร่วมกับ source code
```
