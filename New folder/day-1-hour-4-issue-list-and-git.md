...
| เวลา | หัวข้อ | รูปแบบ |
|---|---|---|
| 0-5 นาที | Recap HTML/CSS จากชั่วโมงก่อน | ถามตอบ |
...
1. CSS ทำหน้าที่อะไร
2. Selector คืออะไร
3. Box model ประกอบด้วยอะไรบ้าง
4. ทำไม form field ควรมี focus state
5. Responsive design สำคัญกับระบบภายในอย่างไร
...
|---|---|---|---|---|
| 001 | Login ไม่ได้ | Anan | OPEN |
| 002 | ส่งแบบฟอร์มไม่ได้ | Mali | IN_PROGRESS |
| 003 | ขอสิทธิ์เข้า dashboard | Kanda | DONE |
...
วางต่อท้ายไฟล์ `styles.css` หรือวางใกล้กับ CSS ของ table
...
วาง CSS ชุดนี้ต่อจาก CSS ของ form ใน `styles.css`
...
# Slide 24: ตรวจผลลัพธ์หลัง Day 1

## ขั้นตอน

เพิ่มหน้า `issue-detail.html` หรือเพิ่ม section รายละเอียดปัญหา 1 รายการ โดยมี:
...
- วันที่แจ้ง
- ผู้แจ้ง
- พื้นที่ comment จาก admin แบบ static

## จุดที่ต้องครบ

- ใช้ semantic HTML
- ใช้ CSS จาก `styles.css`
- มี status badge
- push งานขึ้น GitHub
- update README ว่าเพิ่มอะไร
- เพิ่ม link จากรายการปัญหาไปหน้า detail
- เพิ่ม mock timeline เช่น แจ้งปัญหา, admin รับเรื่อง, ปิดงาน

---

# Slide 25: Recap ชั่วโมงที่สี่
