...
| Day 2 | กำลังปรับ | Hour 1 เหลือ 15 slides และ Hour 2 เหลือ 15 slides; สร้าง Next.js 16 แบบ root-level `app/`, อธิบาย TSX แล้วค่อยย้าย Layout, Static TSX และ Custom CSS โดยยังไม่เปิด Tailwind หรือเพิ่ม Data Model ก่อน Hour 3 |
