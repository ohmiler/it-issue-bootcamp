...
| Day 3 | ปรับครบแล้ว รอตรวจร่วมกัน | ตรวจ indentation ทั้ง 4 ชั่วโมงแล้ว; Hour 1 ตรวจรอบต่อจาก Day 2 แล้ว มี 22 slides: ครอบ CSS เดิมด้วย `@layer base`, ย้าย Style ทีละส่วน และเก็บ `main` ให้ Route ที่ยังไม่ย้าย; Hour 2 ตรวจต่อแล้ว มี 16 slides แยกขั้นย้าย Badge/Table, ลบ CSS หลังย้ายครบ และทดสอบ Empty State ที่ `/issues`; Hour 3 ตรวจต่อแล้ว มี 23 slides แยก FormData/Validation/Callback ทีละขั้น ใช้ UUID เต็ม และแจ้งข้อความโดยไม่ล้าง Form เมื่อ `/issues/new` ไม่มี Callback; Hour 1-4 เรียงจาก Tailwind และ Responsive UI ไปสู่ Client Component, FormData, Validation, Mock Create และ Immutable Status Update; Hour 4 ตรวจต่อแล้ว มี 16 slides แยก Immutable Update, Optional Callback และปุ่มสถานะ พร้อมตรวจ Home แบบแก้ไขกับ `/issues` แบบอ่านอย่างเดียว |
