...
| Day 4 | กำลังปรับใหม่ | Hour 1 ลดเหลือ 15 slides เรียงจาก Mock State ไปสู่ Supabase Project, Schema, Constraint, RLS, Demo Policies, Seed Data, Environment Variables และ TypeScript Type; Hour 2-4 รอตรวจต่อ |
