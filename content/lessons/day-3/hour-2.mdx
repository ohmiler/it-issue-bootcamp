...
Navigation และ Form ใช้ Tailwind แล้ว ส่วน `StatusBadge` และ `IssueList` ยังใช้ CSS เดิมภายใน `@layer base`
...
`IssueForm` และ `IssueList` มี Utility ที่ Section แล้ว จึงลบ `section` กลางได้
