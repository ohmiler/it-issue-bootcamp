...
<LessonCallout type="action">เปิด `package.json` และ `postcss.config.mjs` ในโฟลเดอร์หลักของโปรเจกต์ เพื่อตรวจว่ามีรายการตามตัวอย่าง โดยไม่ต้องแก้ไฟล์หากมีแล้ว</LessonCallout>
...
<LessonCallout type="action">แก้บางส่วนใน `components/IssueForm.tsx`: แทนกลุ่มช่องกรอก `title` เดิมด้วยโค้ดนี้ แล้วใช้ Class แบบเดียวกันกับอีกสามช่อง</LessonCallout>
...
<LessonCallout type="action">แก้บางส่วนใน `components/IssueForm.tsx`: แทนปุ่มส่งฟอร์มเดิมที่ท้าย `<fieldset>` ด้วยโค้ดนี้</LessonCallout>
...
<LessonCallout type="action">รัน `npm run dev` ในโฟลเดอร์หลักของโปรเจกต์ หากยังไม่ได้รัน แล้วเปิด `/`, `/issues`, `/issues/new` และ `/issues/001` เพื่อลองหน้าเว็บ</LessonCallout>
