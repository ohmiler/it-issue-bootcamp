...
### เปิดใช้งานใน `app/globals.css`

Day 2 เราลบ Tailwind Import ออกชั่วคราวเพื่อใช้ Custom CSS เพียงชุดเดียว ตอนนี้ให้เพิ่มบรรทัดนี้กลับไว้ด้านบนสุดของไฟล์:

```css
@import "tailwindcss";
```

เมื่อเพิ่มบรรทัดนี้ Tailwind และ Preflight จะเริ่มทำงาน จากนั้นเราจะทยอยเปลี่ยน Style เดิมเป็น Utility Class และลบ Selector ที่ซ้ำกัน
