...
## Slide 1: Day 1 - จากหน้าเว็บธรรมดาไปสู่ Web Application

วันนี้เราจะไม่เริ่มจากการจำ tag หรือ syntax ทันที แต่จะเริ่มจากภาพรวมว่าเว็บหนึ่งระบบทำงานอย่างไร

<TeachingFlowDiagram variant="bootcamp-map" />

{/* slide-break: เป้าหมายของชั่วโมงนี้ */}

- เห็นว่า HTML, CSS, TypeScript อยู่ตรงไหนในระบบจริง
- เข้าใจภาพรวม frontend, backend, database
- รู้ว่า prototype วันนี้จะต่อยอดเป็นระบบจริงในวันถัดไป
...
### สิ่งที่ระบบนี้ต้องทำได้

- รับปัญหาจากผู้ใช้งานผ่านหน้าเว็บ
- เก็บข้อมูลปัญหาเป็นรายการที่ตรวจสอบได้
- ให้เจ้าหน้าที่ IT ติดตามและเปลี่ยนสถานะงาน
- วางฐานสำหรับ login, role และ database ในวันถัดไป
...
{/* slide-break: ตัวอย่างปัญหาที่ระบบนี้รับได้ */}
...
Day 1 จะสร้าง **static prototype** ก่อน เพื่อให้ทุกคนเห็นหน้าตาและ flow ของระบบโดยยังไม่ต้องกังวลเรื่อง framework หรือ database
...
{/* slide-break: ภาพรวม 5 วันของ Bootcamp */}
...
{/* slide-break: Web Application ทำอะไรได้บ้าง */}
...
{/* slide-break: เทคโนโลยีฝั่ง Frontend */}
...
{/* slide-break: Backend ตรวจอะไรบ้าง */}

### ตัวอย่างในระบบแจ้งปัญหา

เมื่อผู้ใช้กด submit:

<TeachingFlowDiagram variant="backend-validation" />
...
{/* slide-break: ตัวอย่างตาราง Issue */}
...
{/* slide-break: CRUD ในระบบแจ้งปัญหา */}
...
{/* slide-break: CRUD ในระบบจัดการผู้ใช้ */}
...
<TeachingFlowDiagram variant="runtime-flow" />

{/* slide-break: ตัวอย่างหน้าที่ของแต่ละเทคโนโลยี */}
...
{/* slide-break: ตัวอย่างคำถามที่ดีต่อ LLM */}
...
<TeachingFlowDiagram variant="issue-example-flow" />

---

## Slide 16: พื้นฐาน Mindset ที่ดีในการพัฒนาระบบ

### พื้นฐาน Mindset ที่ดีในการพัฒนาระบบ

- มองระบบเป็น flow ตั้งแต่ผู้ใช้กดจนถึงข้อมูลถูกบันทึก
- แยกหน้าที่ของ frontend, backend และ database ให้ชัด
- ตรวจข้อมูลและสิทธิ์ที่ backend เสมอ
- คิดเผื่อ error เช่น login ไม่ผ่าน ข้อมูลไม่ครบ หรือบันทึกไม่สำเร็จ
- อ่าน code จาก LLM โดยถามว่าแต่ละส่วนทำหน้าที่อะไรในระบบ
- อธิบาย flow ให้ได้ก่อนลงมือเขียนหรือแก้ code

### Key Message

พื้นฐาน mindset ที่ดีคือไม่มองแค่หน้าจอหรือ code แยกชิ้น แต่มองทั้งระบบว่าข้อมูลไหลอย่างไร ใครรับผิดชอบอะไร และถ้าเกิดข้อผิดพลาดระบบควรรับมืออย่างไร
