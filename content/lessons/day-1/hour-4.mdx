...
```html
<section class="issue-list" aria-labelledby="issue-list-title">
...
<LessonCallout type="action">เพิ่ม Style ของ `.issue-list` และ Wrapper ต่อใน `style.css`</LessonCallout>
