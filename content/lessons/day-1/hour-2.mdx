...
{/* slide-break: HTML ใช้กำหนดโครงสร้างของหน้าเว็บ */}
...
<TeachingFlowDiagram variant="frontend-responsibilities" />

{/* slide-break: จำหน้าที่ของ HTML, CSS, TypeScript แบบง่าย */}
...
{/* slide-break: ตัวอย่างเดียวกันใน 3 ภาษา */}
