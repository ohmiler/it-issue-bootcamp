...
| ส่วน | ก่อนปรับ | หลังปรับ |
|---|---|---|
| ข้อมูลปัญหา | เขียนอยู่ใน `<td>` ของแต่ละแถว | เก็บรวมไว้ใน Array `issues` |
| โครงสร้างแถว | Copy `<tr>` พร้อมข้อมูลซ้ำทุกครั้ง | เขียน `<tr>` เป็นแบบสำหรับสร้างทุกแถว |
| เมื่อต้องเพิ่มปัญหา | Copy JSX แล้วแก้ข้อความ | เพิ่มข้อมูลหนึ่งรายการใน `issues` |
