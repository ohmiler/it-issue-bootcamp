...
การเปิด RLS คือการบอก database ว่า “อย่าให้ใครเข้าถึงข้อมูลได้เองจนกว่าจะมี policy อนุญาต” ทำให้เราคุมได้ว่าใครอ่าน เพิ่ม หรือแก้ไข row ไหนได้บ้าง
...
ให้ไปที่ `src/app/components/IssueForm.tsx` แล้วเติม `updatedAt` ใน object ที่ return จาก `createIssueFormInput`
